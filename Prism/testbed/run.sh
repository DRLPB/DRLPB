...
LAUNCH_TEMPLATE=lt-058a9771ce33ec296	# Ohio
...
function sync_payload
{
	...
	aws s3 rm --quiet --recursive s3://prismnew/payload
	aws s3 sync --quiet payload s3://prismnew/payload
...
{
	ssh $1 -- "rm -f /home/ubuntu/*.tar.gz && rm -rf /home/ubuntu/payload && wget https://prismnew.s3.amazonaws.com/payload/$1.tar.gz -O local.tar.gz && wget https://prismnew.s3.amazonaws.com/payload/common.tar.gz && mkdir -p /home/ubuntu/payload && tar xf local.tar.gz -C /home/ubuntu/payload && tar xf common.tar.gz -C /home/ubuntu/payload"
}
